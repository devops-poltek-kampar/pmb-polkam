...
@section('content')
    ...
    {{-- <div class="row my-4">
        <div class="col">
            <div class="card custom-card">
                <div class="card-body">
                    <h6 class="mb-0">Hello, Selamat Datang Di Sistem Penerimaan Mahasiswa Baru Politeknik Kampar</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card bg-info">
        <div class="card-body">
            <h1 class="mb-3 fw-bold text-white">Selamat Datang!</h1>
            <p class="mb-4 text-white">Selamat Datang Di Sistem Penerimaan Mahasiswa Baru Berbasis Online Politeknik Kampar!
            </p>
