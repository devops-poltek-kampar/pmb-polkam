            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="{{ url('/keuangan/dashboard') }}" class="side-menu__item">
                        ...
                        <!-- Start::slide -->
                        {{-- <li class="slide">
                            <a href="{{ url('/keuangan/data-registrasi') }}" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                                    enable-background="new 0 0 24 24" viewBox="0 0 24 24" width="25px"
                                    height="25px">
                                    <path
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label">PMB</span>
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="{{ url('/keuangan/data-pembayaran') }}" class="side-menu__item">Data
                                        Pembayaran</a>
                                </li>
