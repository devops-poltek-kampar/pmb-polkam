        ...
        <div class="col-xl-4 col-lg-5 col-md-7 col-sm-10">
            <div class="card forgot-card border-0">
                <div class="card-body p-5 text-center">
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ url('/auth/forgot-password/reset') }}">
                        @csrf


                        <input type="hidden" name="email" value="{{ $forgotPassword->pmb_users_email }}">
                        ...
                        <button type="submit" class="btn btn-primary w-100 py-2">
                            <i class="bi bi-envelope"></i> Reset Password
                        </button>
                    </form>
